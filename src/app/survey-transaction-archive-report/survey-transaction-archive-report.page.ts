...
@Component({
  selector: 'app-survey-transaction-archive-report',
  templateUrl: './survey-transaction-archive-report.page.html',
  styleUrls: ['./survey-transaction-archive-report.page.scss'],
})

export class SurveyTransactionArchiveReportPage implements OnInit, AfterViewInit {
  ...
  search(currIndex) {
    this.spinner = true;
    const url =
      this.manager.appConfig.apiurl + "reports/archiveSurveyTransactionReport";
    ...
    this.loading
      ...
      .then((el) => {
        ...
        const url =
          ...
          "reports/archiveSurveyTransactionExcelReport"; //surveyTransactionExcelReport
        ...
        this.http
          ...
          .subscribe((data: any) => {
            ...
            if (data.message == "SUCCESS") {
              ...
              let excelTitle = "Survey Transaction Archive Report";
              let excelHeaderData = [
                "Date",
                "State",
                "Township",
